...
char* TRAIN_IMAGE = "/Users/eric/Documents/AI/newAINeuron3/newAINeuron3/data/train-images.idx3-ubyte";
char* TRAIN_LABEL = "/Users/eric/Documents/AI/newAINeuron3/newAINeuron3/data/train-labels.idx1-ubyte";
char* TEST_IMAGE = "/Users/eric/Documents/AI/newAINeuron3/newAINeuron3/data/t10k-images.idx3-ubyte";
char* TEST_LABEL = "/Users/eric/Documents/AI/newAINeuron3/newAINeuron3/data/t10k-labels.idx1-ubyte";
...
void read_mnist_char(char *file_path, int num_data, int len_info, int arr_n, unsigned char data_char[][784], int info_arr[])
{
    int i, j, k, fd;
    unsigned char *ptr;
...
void read_mnist_char2(char *file_path, int num_data, int len_info, int arr_n, unsigned char data_char[][1], int info_arr[])
{
    int i, j, k, fd;
    unsigned char *ptr;
...
void load_mnist()
{
    ...
    read_mnist_char2(TRAIN_LABEL, NUM_TRAIN, LEN_INFO_LABEL, 1, train_label_char, info_label);
    label_char2int(NUM_TRAIN, train_label_char, train_label);
    
    read_mnist_char2(TEST_LABEL, NUM_TEST, LEN_INFO_LABEL, 1, test_label_char, info_label);
